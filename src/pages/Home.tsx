...
const Home = () => {
    ...
    return (
        <>
            ...
            <s.HomeTitle>
                <h2>
                    {searchString && setSearchString.length > 0 ? 'Your search reasults' : 'Recipes of the day'}
                </h2>
            </s.HomeTitle>
            <s.Container>
                ...
                {!loading && (!recipes || recipes?.length === 0) && <div>No recipes found, try searching again.</div>}
            </s.Container>
